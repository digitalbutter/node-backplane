...
var memoryMessageStore = require("./memoryMessageStore.js")
...
module.exports = (function(){
    ...
    my.messageStore = { 
        save: function(){ return memoryMessageStore.save(bus,channel,content) }
        ,getChannelMessages: function(){ memoryMessageStore.getChannelMessages(bus,channel,since,callback) }
        ,getBusMessages: function(){ memoryMessageStore.getBusMessages(bus,since,callback) }
    };
